...
const imageToPdf = async (imageName,pdfName) => {
	...
	await imgToPDF(pages, imgToPDF.sizes.A4H)
...
const main = async () => {
	...
	const newImageDimensions = { height: Math.floor(imageDimensions.width * paperDimensions.ratio), width: imageDimensions.width };
