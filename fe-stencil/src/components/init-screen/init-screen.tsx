...
export class InitScreen {
  ...
  @Event() goToControlPanelScreen: EventEmitter;
  @Event() clickInitScreenEditSettingsButton: EventEmitter;
      ...
      <div>
        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
          <div style={{ display: 'flex', gap: '10px' }}>
            ...
            <button class="btn btn-accent" onClick={() => this.goToControlPanelScreen.emit()}>
              Control panel
            </button>
          </div>
        </div>
